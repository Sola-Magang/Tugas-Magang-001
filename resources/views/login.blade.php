    ...
    <body class="h-full">
        <div class=" flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="mt-2">
                    <input id="email" name="email" value="{{ Session::get('email') }}" type="email" autocomplete="email" required class="input-login @error('email')border-red-500 @enderror">
                    @error('email')
                ...
                <div class="mt-2">
                    <input id="password" name="password" type="password" autocomplete="current-password" required class="input-login @error('password') border-red-500 @enderror">
                    @error('email')
                    <div class="text-sm text-red-500 mt-0">
                        {{ $message }}
                    </div>
