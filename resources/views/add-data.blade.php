                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-2" action="{{ route('pd.submit') }}" method="post"> @csrf
                            ...
                            <div class="flex justify-between">
                                ...
                                <button type="submit" class="max-w-md text-white bg-gray-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 transition-colors">Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
